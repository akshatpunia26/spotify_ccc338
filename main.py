...
if st.button('Generate Playlist'):
    playlist1 = playlist_data[(playlist_data['decade'] == decade1) & (playlist_data['playlist_uri'].str.contains(str(start_year1))) & (playlist_data['playlist_uri'].str.contains(str(end_year1)))].head(20)
    playlist2 = playlist_data[(playlist_data['decade'] == decade2) & (playlist_data['playlist_uri'].str.contains(str(start_year2))) & (playlist_data['playlist_uri'].str.contains(str(end_year2)))].head(20)
